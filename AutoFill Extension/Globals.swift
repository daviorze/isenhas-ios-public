...
//  AutoFillPasswords
//
//  Created by Davi Orzechowski on 14/02/23.
//
//  Functions used in Autofill extension
...
@objcMembers final class SwiftHelper: NSObject {
    ...
    class func vaultKeyExistsInKeychain(account: String) -> Bool {
        ...
        if status == errSecInteractionNotAllowed {
            // 🔐 Existe, mas está protegido por biometria
            return true
        }
    ...
    /*encryptionKey loaded in LoginCredentialProvider from Keychain*/
